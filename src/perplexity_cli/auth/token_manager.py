...
class TokenManager:
    """Manages persistent token storage with secure file permissions.

    Tokens are stored in ~/.config/perplexity-cli/token.json with
    ...
    def save_token(self, token: str) -> None:
        ...
        Raises:
            ...
            RuntimeError: If the token path is invalid.
        """
        try:
            # Write token to file
    ...
    def load_token(self) -> str | None:
        ...
        Returns:
            The stored authentication token, or None if not found.
