...
The package's public abstract contract — the :class:`HttpErrorClassifier`,
:class:`HttpErrorHandler`, and :class:`HttpStatusClassifier` protocols — is
defined here so that the stable facade honestly owns the abstract interface
its callers depend on.  The concrete implementations live in
:mod:`perplexity_cli.utils.http_errors.impl`.
"""
