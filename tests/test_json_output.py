...
class TestAuthLoginJson:
    ...
    @patch("perplexity_cli.runners.auth.get_save_cookies_enabled", return_value=True, autospec=True)
...
class TestConfigSetJson:
    ...
    @patch("perplexity_cli.runners.config.clear_feature_config_cache", autospec=True)
