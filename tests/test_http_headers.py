...
class TestBuildPerplexityHeaders:
    ...
    def test_basic_headers(self):
        ...
        headers = build_perplexity_headers(token=None, options=HeaderOptions(base_url="https://example.com"))
    ...
    def test_authorization_with_token(self):
        ...
        headers = build_perplexity_headers(token="abc", options=HeaderOptions(base_url="https://example.com"))
    ...
    def test_csrf_token_from_cookies(self):
        ...
        headers = build_perplexity_headers(
            token=None, cookies={"csrftoken": "xyz"}, options=HeaderOptions(base_url="https://example.com")
        )
    ...
    def test_no_csrf_without_cookies(self):
        ...
        headers = build_perplexity_headers(token=None, cookies=None, options=HeaderOptions(base_url="https://example.com"))
        assert "X-CSRFToken" not in headers

    def test_custom_content_type(self):
        """Test that a custom content type is used."""
        headers = build_perplexity_headers(
            token=None, options=HeaderOptions(content_type="multipart/form-data", base_url="https://example.com")
        )
    ...
    def test_accept_header(self):
        ...
        headers = build_perplexity_headers(
            token=None, options=HeaderOptions(accept="text/event-stream", base_url="https://example.com")
        )
