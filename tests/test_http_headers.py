...
class TestBuildPerplexityHeaders:
    ...
    def test_basic_headers(self):
        ...
        headers = build_perplexity_headers(None, header_extras=(None, "https://example.com"))
    ...
    def test_csrf_token_from_cookies(self):
        ...
        headers = build_perplexity_headers(
            None, {"csrftoken": "xyz"}, header_extras=(None, "https://example.com")
        )
    ...
    def test_accept_header(self):
        ...
        headers = build_perplexity_headers(
            None, header_extras=("text/event-stream", "https://example.com")
        )
